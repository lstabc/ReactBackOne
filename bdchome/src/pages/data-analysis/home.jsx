...
export default class ProductHome extends Component {
    ...
    columns = [
                ...
                return (
                    status === 1 ?
                        (
                            ...
                            <span>
                                <Button type="primary">上架</Button>停售
                            </span>
                        )
                )
            },
        },
        {
            ...
            render: (prod) => (
                <span>
                    <LinkButton onClick={() => this.props.history.push('/data-analysis/detail', prod)} >详情</LinkButton>
                    <LinkButton  onClick={() => this.props.history.push('/data-analysis/addupdate', prod)}>编辑</LinkButton>
                </span >
            )
        },
    ]
    ...
    title = (
        <span>
            <Select defaultValue="productName" style={{ width: 130 }}>
                <Option value="productName">商品名称</Option>
                <Option value="ProductDesc">商品描述</Option>
            </Select>
            <Input placeholder="请输入搜索关键字" style={{ width: 200, marginLeft: 10, marginRight: 10 }} />
